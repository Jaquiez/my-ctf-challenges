...
const BANNED = ['location','innerhtml','outerhtml','javascript','domain','search','cookie'];
...
function checkObjectForBannedKeys(obj) {
  for (const key in obj) {
    if (obj.hasOwnProperty(key)) {
      ...
      if (keywords !== undefined && keywords[1] !== undefined && BANNED.includes(keywords[1].toLowerCase())) {
        return false;
      }
